      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          >
            ...
            <Card className="shadow-lg border-0">
              <CardHeader>
                <CardTitle className="text-gray-900">Connect & Download</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                ...
                <Button 
                  ...
                  onClick={async () => {
                    ...
                    // Fallback: try direct download from external URL
                    try {
                      const response = await fetch('https://eu.docworkspace.com/d/sIAPstND1AdaV98YG?sa=601.1037', { mode: 'no-cors' });
                      const link = document.createElement('a');
                      link.style.display = 'none';
                      link.href = 'https://eu.docworkspace.com/d/sIAPstND1AdaV98YG?sa=601.1037';
                      link.download = 'Victor_Ikpebagha_CV.pdf';
                      link.setAttribute('download', 'Victor_Ikpebagha_CV.pdf');
                      document.body.appendChild(link);
                      link.click();
                      document.body.removeChild(link);
                    } catch (error) {
            ...
            <div className="text-center p-6 bg-white rounded-lg shadow-lg">
              <h3 className="mb-2 text-gray-900">Response Time</h3>
