...
export function About() {
  const tools = [
    "Figma", "JavaScript", "React", "Next.js", "TypeScript", 
    "Tailwind CSS", "Adobe Creative Suite", "Framer", "Notion"
  ];
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="mb-6 text-gray-600 dark:text-gray-300">
              I'm passionate about creating digital experiences that make people's lives easier. 
              With good years of experience in design and development, I bridge the gap between 
