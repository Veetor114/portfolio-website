  ...
  const caseStudies = [
    {
      ...
      technologies: ["Figma", "React", "Next.js", "Stripe API", "Google Analytics"]
    },
    {
      id: 2,
      ...
      process: [
        ...
        "Implemented Firebase + Node.js backend for secure data storage and real-time syncing",
        ...
        "Integrated quick-action buttons for Send Money, Request, Pay Bills, and Savings with Firebase functionality",
      ...
      technologies: ["React", "Tailwind CSS", "Firebase", "Node.js", "Chart.js"]
    },
    {
      id: 3,
